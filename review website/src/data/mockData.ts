  ...
  findings: [
    {
      ...
      whatsHappening: "Multiple buttons and form inputs lack proper ARIA labels, making the site difficult to navigate for screen reader users. This violates WCAG 2.1 Level A requirements.",
      impact: 4,
      effort: 2,
      confidence: 5,
      recommendedDirection: "Add aria-label attributes to all interactive elements without visible text labels. Use aria-describedby for complex form fields.",
      evidence: [
        {
          type: "image",
    ...
    },
    {
      ...
      whatsHappening: "First Contentful Paint (FCP) is 3.2s, which is above the recommended 1.8s threshold. Large unoptimized images and blocking JavaScript are the main culprits.",
      impact: 5,
      effort: 3,
      confidence: 5,
      recommendedDirection: "Implement image lazy loading, code splitting, and optimize critical CSS. Consider using a CDN for static assets.",
      evidence: [
        {
          type: "image",
    ...
    },
    {
      ...
      whatsHappening: "Users must complete 5 steps to checkout, with no option to save progress. 23% of users abandon at step 3 (payment information).",
      impact: 5,
      effort: 4,
      confidence: 4,
      recommendedDirection: "Reduce checkout to 2-3 steps. Add guest checkout option and save progress functionality. Consider one-click checkout for returning users.",
      evidence: [
        {
          type: "image",
    ...
    },
    {
      ...
      whatsHappening: "Pricing information is buried in footer and uses confusing terminology. Users report difficulty understanding subscription tiers.",
      impact: 4,
      effort: 2,
      confidence: 4,
      recommendedDirection: "Create a dedicated pricing page with clear comparison table. Use simple, benefit-focused language. Add tooltips explaining features.",
      evidence: [
        {
          type: "image",
    ...
    },
    {
      ...
      whatsHappening: "Several buttons and links have touch targets smaller than the recommended 44x44px minimum, causing accidental taps and user frustration.",
      impact: 3,
      effort: 1,
      confidence: 5,
      recommendedDirection: "Increase padding on all interactive elements to ensure minimum 44x44px touch targets. Test on actual devices.",
      evidence: [
        {
          type: "image",
    ...
    },
    {
      ...
      whatsHappening: "After initial signup, users receive only transactional emails. No personalized recommendations or re-engagement campaigns.",
      impact: 3,
      effort: 3,
      confidence: 3,
      recommendedDirection: "Implement personalized product recommendations based on browsing history. Send weekly digest emails with curated content.",
      evidence: [],
    },
  ],
  competitors: [
  ...
  findings: [
    {
      ...
      whatsHappening: "Several interactive elements cannot be accessed via keyboard, creating barriers for users who rely on keyboard navigation.",
      impact: 3,
      effort: 2,
      confidence: 4,
      recommendedDirection: "Add tabindex and keyboard event handlers to all interactive elements. Ensure focus indicators are visible.",
      evidence: [],
    },
  ],
  competitors: [],
  ...
  findings: [
    {
      ...
      whatsHappening: "Users must complete 7 steps to log a single health entry, causing frustration and abandonment.",
      impact: 5,
      effort: 4,
      confidence: 5,
      recommendedDirection: "Simplify to 2-3 steps with smart defaults and bulk entry options.",
      evidence: [],
    },
    {
      id: "finding-3-2",
      ...
      whatsHappening: "Text contrast ratios fall below WCAG AA standards in multiple areas, making content difficult to read.",
      impact: 4,
      effort: 2,
      confidence: 5,
      recommendedDirection: "Update color palette to meet WCAG AA contrast requirements (4.5:1 for normal text).",
      evidence: [],
    },
  ],
  competitors: [],
  ...
  findings: [
    {
      ...
      whatsHappening: "App search only searches product names, not descriptions or categories. Users report difficulty finding specific items.",
      impact: 3,
      effort: 3,
      confidence: 4,
      recommendedDirection: "Expand search to include descriptions, categories, and tags. Add filters and sorting options.",
      evidence: [],
    },
  ],
  competitors: [],
